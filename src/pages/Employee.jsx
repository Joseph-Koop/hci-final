            ...
            {employeeList.map((employee) => (
              <tr key={employee.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <button onClick={() => openEditModal(employee)} className="px-3 py-1 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition mr-2">
                    Edit
                  </button>
                  <button onClick={() => handleDeleteEmployee(employee.id)} className="px-3 py-1 bg-red-500 text-white rounded-lg hover:bg-red-600 transition">
                    Delete
                  </button>
                </td>
              </tr>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-lg border border-orange-300 space-y-4">
            ...
            <form onSubmit={handleAddEmployee} className="space-y-4 text-black">
              <div>
      ...
      {showEditModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-lg border border-orange-300 space-y-4">
            ...
            <form onSubmit={handleEditEmployee} className="space-y-4 text-black">
              <div>
                <label className="block text-gray-700 font-medium mb-1">Name</label>
                <input
                  type="text"
